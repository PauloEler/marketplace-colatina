# Backlog — Inteligência

## Problema da jornada

Decisões do produto podem ser tomadas por impressão quando dados agregados e comparáveis não estão disponíveis.

## Ideias registradas

| Ideia | Problema observado | Estado |
|---|---|---|
| painel de utilidade por jornada | visitas não mostram tarefas resolvidas | descoberta |
